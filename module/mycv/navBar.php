            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item Nav_Span1" href="goldorak.php?page=home" target="_blank">
                                    <img class="p-2" src="../img/goldorak/avatar/avatar_goldorak_01.webp" alt="icone du bouton goldorak" style="width:30px;">    
                                    Goldorak
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item Nav_Span1" href="garageparrot.php?page=home" target="_blank">
                                    <img class="p-2" src="../img/garageParrot/icon/garage_black_75x75.png" alt="icone du bouton garage parrot" style="width:30px;">    
                                    Garage Parrot
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item dropdown custom-border-md-bottom">
                        ...
                        <a class="nav-link dropdown-toggle" href="" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img class="p-2 h-75" src="img/icon/person-vcard.svg" alt="icone du bouton s'identifier">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item Nav_Span1" href="mailto:ludovic.folaco@free.fr">
                                    <img class="p-2 h-75" src="img/icon/envelope-at.svg" alt="icone du bouton s'identifier">
                            ...
                            <li>
                                <a class="dropdown-item Nav_Span1" href="https://www.linkedin.com/in/ludovic-follaco-a74b5394/" target="_blank">
                                    <img class="p-2 h-75" src="img/icon/linkedin.svg" alt="icone du bouton s'identifier">
