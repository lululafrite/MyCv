    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-flex justify-content-center align-items-center">
                    <a class="nav-link active text-light" aria-current="page" href="goldorak.php?page=home">
                        <img class="p-0 px-2 mb-1" src="../img/common/icon/house.svg" alt="icone événements">
                        Accueil
                    </a>
                </li>
                ...
                <li class="nav-item dropdown d-flex justify-content-center align-items-center">
                    <a class="nav-link dropdown-toggle text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="p-0 px-2 mb-1" src="../img/common/icon/calendar2-event.svg" alt="icone événements">
                        Evénements
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item text-light" href="goldorak.php?page=events">
                                <img class="p-0 pe-2 mb-1" src="../img/common/icon/calendar2-event.svg" alt="icone événements">  
                                Consulter
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item text-light" href="goldorak.php?page=events#SalonDeParis2023">
                                <img class="p-0 pe-2 mb-1" src="../img/common/icon/incognito.svg" alt="icone joystick du menu jeux">  
                                Manga Paris 2023
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item text-light" href="goldorak.php?page=events#SalonJapanExpo2024">
                                <img class="p-0 pe-2 mb-1" src="../img/common/icon/tencent-qq.svg" alt="icone joystick du menu jeux">  
                                Japan Expo 2024
                            </a>
                        </li>
                    </ul>
            ...
            <?php if($_SESSION['dataConnect']['type'] === 'Administrator' || $_SESSION['dataConnect']['type'] === 'Member'){ ?>
                <li class="nav-item d-flex justify-content-center align-items-center">
                    <a class="nav-link active text-light" aria-current="page" href="goldorak.php?page=media">
                        <img class="p-0 px-2 mb-1" src="../img/common/icon/card-image.svg" alt="icone événements">
                        Médias
                    </a>
                </li>
            <?php } ?>
            ...
            <?php if($_SESSION['dataConnect']['subscription'] != 'Vénusia' && $_SESSION['dataConnect']['type'] != 'User' && $_SESSION['dataConnect']['type'] != 'Guest'){ ?>
                <li class="nav-item dropdown d-flex justify-content-center align-items-center">
                    <a class="nav-link dropdown-toggle text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="p-0 px-2 mb-1" src="../img/common/icon/joystick.svg" alt="icone joystick du menu jeux">  
                        Jeux
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item text-light" href="goldorak.php?page=goldorakgo">
                                <img class="p-0 pe-2 mb-1" src="../img/common/icon/crosshair2.svg" alt="icone du menu s'identifier">    
                                Goldorak Go
                            </a>
                        </li>
                    <?php if($_SESSION['dataConnect']['subscription'] === 'Goldorak' ){ ?>
                        <li>
                            <a class="dropdown-item text-light" href="goldorak.php?page=commander">
                                <img class="p-0 pe-2 mb-1" src="../img/common/icon/dice-6.svg" alt="icone du menu s'identifier">    
                                My Commander
                            </a>
                        </li>
                    <?php } ?>
            ...
            <?php if($_SESSION['dataConnect']['type'] === 'Administrator'){ ?>
                <li class="nav-item dropdown d-flex justify-content-center align-items-center">
                    <a class="nav-link dropdown-toggle text-light" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="px-2 mb-1" src="../img/common/icon/people.svg" alt="icone du bouton s'identifier">    
                        Profils
                    </a>
                    <ul class="dropdown-menu">
                        <li>    
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item text-light" href="goldorak.php?page=connexion">
                                <img class="p-0 m-0 pe-2" src="../img/common/icon/box-arrow-in-left.svg" alt="icone du bouton connexion">    
                                Connexion
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li>
                            <a class="dropdown-item text-light" href="goldorak.php?page=disconnect">
                                <img class="p-0 m-0 pe-2" src="../img/common/icon/box-arrow-right.svg" alt="icone du bouton déconnexion">    
                                Déconnexion
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <li>
                            <form action="goldorak.php?page=userEdit" method="post">
                                <button class="dropdown-item text-light" type="submit" name="btn_monCompte">
                                    <img class="p-0 m-0 pe-2" src="../img/common/icon/person-gear.svg" alt="icone du bouton mon compte">    
                                    Mon compte
                                </button>
                            </form>
                        </li>
