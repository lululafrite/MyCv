...
function returnUrl(){
    ...
    if (valeurSession === "1"){
        ...
        if(currentURL.search(goldorak) !== -1){
            ...
            window.location.href = "http://mycv/goldorak/index.php?page=home";

        }else if(currentURL.search(garageParrot) !== -1){
            
            window.location.href = "http://mycv/garageparrot/index.php?page=home";
        ...
        if(currentURL.search(goldorak) !== -1){
            ...
            window.location.href = "https://www.follaco.fr/garageparrot/public/index.php?page=home";
